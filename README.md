...
## 📁 Folder Structure
- **Day1** – Basic C# programs, syntax, input/output, operators  
- **Day2** – Conditional statements, loops, functions, basic projects  
- **Day3** – OOPS concepts, classes & objects, constructors, inheritance    
- *(More folders will be added as training continues)*
